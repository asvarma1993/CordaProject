...
public class LoCApplicationState implements LinearState{
    ...
    private List<CommentsState> comments = new ArrayList<CommentsState>();

    private String locStatus;
    private int amendmentNumber;
    private List<AbstractParty> participants;

    public LoCApplicationState(String lcNumber, Party applicant, Party beneficiary, Party issuingBank,
                               Party advisingBank, UniqueIdentifier locID, String applicationCreationDate, String lcType,
                               String applicationRuleCode, String appRuleDesc, String applicantID,
                               String applicantAddress, String currency, double amount,
                               String creditAmountTolerance, String debitAmountTolerance, String issueDate,
                               String expiryDate, String expiryPlace, int presentationDays, String shipmentDate,
                               int shipmentPeriod, String incoTerms, String partialShipment, String transhipmentShipment,
                               String portOfLoading, String portOfDischarge, String placeOfTakingInCharge,
                               String finalDestination, String beneficiaryName, String beneficiaryAddress,
                               String issuingBankName, String issuingBankAddress, String advisingBankName,
                               String advisingBankAddress, String creditAvailableBy, String creditAvailableWith,
                               String bankName, String bankAddress, String ifscCode, String chargesFrom,
                               String chargesDefaultAccount, String waiveCharges, String chargeCodeOne,
                               String chargeDebitAccountNum, String chargeCurrency, double chargeAmount,
                               String commissionCode, String waiveCommissionFlag, String commissionPartyCharge,
                               String commissionCurrency, double commissionAmount, String commissionAccount, String marginRequired,
                               String marginCalcBase, String marginPercentage, String marginDebitAccount, double marginAmount,
                               String marginCreditAccount, String draft, String poPiContractRegNum, double poAmount, String poDate, String descOfGoods, String docsRequired,
                               String additionalConditions, List<CommentsState> comments, String locStatus, int amendmentNumber, List<AbstractParty> participants) {
    ...
    public List<CommentsState> getComments() {
        return comments;
    }

    public void setComments(List<CommentsState> comments) {
        this.comments = comments;
    }
