...
@InitiatingFlow
@StartableByRPC
public class AcceptLoCFlow extends FlowLogic<String> {

    private final static Logger logger = LoggerFactory.getLogger(AcceptLoCFlow.class);
    private String locID;
  //  private LoCApplicationState locApplication;
   // private List<AbstractParty> parties;

    public AcceptLoCFlow(String locID) {
        this.locID = locID;
    ...
    public String call() throws FlowException {
        ...
        if (application.size() == 1) {
            ...
            Command command = new Command(new LoCContract.Commands.AcceptLoC(), getOurIdentity().getOwningKey());
            ...
            LoCApplicationState state = new LoCApplicationState(locApplication.getLcNumber(), locApplication.getApplicant(), locApplication.getBeneficiary(),
                    ...
                    locApplication.getDocsRequired(), locApplication.getAdditionalConditions(), locApplication.getComments(), "ACCEPTED", locApplication.getAmendmentNumber(),
